...
var _astHelper = require('../helpers/astHelper');
...
var processFiles = exports.processFiles = function processFiles(_ref) {
  ...
  if (filePath.match(/^\S*(?<!index)(?<!test)\.js$/gi)) {
    return new Promise(function (resolve) {
      var _transformFileSync = (0, _babelCore.transformFileSync)(filePath, { presets: ['env', 'stage-0', 'stage-1', 'stage-2', 'stage-3', 'react'] }),
      ...
      var props = (0, _astHelper.getAllProps)(ast, componentName);
      var _requiredProps = (0, _astHelper.getRequiredProps)(props);
      ...
      var myContentBase = _mustache2.default.render(template, {
        ...
        requiredProps: function requiredProps() {
          return _requiredProps.map(function (prop, key) {
            return prop.key + ': ' + prop.value + (key < _requiredProps.length - 1 && ',' || '');
          });
        }
      });
